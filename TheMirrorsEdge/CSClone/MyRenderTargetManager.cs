...
namespace TheMirrorsEdge.CSClone;
...
internal unsafe struct MyRenderTargetManager
{
    ...
    /// <para>- Follows dynamic resolution</para>
    /// </summary>
    [FieldOffset(0x28)] public Texture* WetnessMap;
    ...
    /// <para>- Follows dynamic resolution</para>
    /// </summary>
    [FieldOffset(0x38)] public Texture* SpecularMap;

    /// <summary>
    /// Bump Map
    /// <para>- Follows dynamic resolution</para>
    /// </summary>
    [FieldOffset(0x40)] public Texture* EmissionMap;
    ...
    /// </summary>
    [FieldOffset(0x258)] public Texture* MainBackBufferNoUI;
