...
{
                    internal TheMirrorsEdgePlugin           MirrorsEdgePlugin           { get; private set; } = null!;
    ...
    public static DalamudServices Create(IDalamudPluginInterface plugin, TheMirrorsEdgePlugin mirrorsEdge)
    {
